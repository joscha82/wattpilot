...
| `updateInverter` | Update Inverter | Contains information of connected PV inverter / power meter | `{"type": "updateInverter", "partial": false, "id": "<some_id>", "paired": true, "deviceFamily": "DataManager", "label": "<some_name>", "model": "PILOT", "commonName": "pilot-0.5e-1670626369628648631_1599713577", "ip": "<some_ip>", "connected": true, "reachableMdns": true, "reachableUdp": true, "reachableHttp": true, "status": 0, "message": "ok"}` |
